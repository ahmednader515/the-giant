...
export default function BalancePage() {
  ...
  const bankMasrDigitalWalletNumber = "01227682189";
  const whatsappNumber = "01227682189";
  const whatsappLink = `https://wa.me/201227682189`;
        ...
        <Card className="border-brand/20 bg-brand/5">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              إضافة رصيد عبر محفظة بنك مصر الرقمية
            </CardTitle>
            <CardDescription>
              محفظة بنك مصر الرقمية تستقبل الأموال من أي محفظة. قم بالتحويل إلى الرقم التالي ثم أرسل صورة الإيصال
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="bg-card rounded-lg p-4 border-2 border-brand/30">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-muted-foreground mb-1">رقم محفظة بنك مصر الرقمية</p>
                  <p className="text-2xl font-bold text-brand">{bankMasrDigitalWalletNumber}</p>
                </div>
                <Button
                  variant="outline"
                  size="icon"
                  onClick={() => copyToClipboard(bankMasrDigitalWalletNumber, setCopiedWalletNumber)}
                  className="h-10 w-10"
                >
                  {copiedWalletNumber ? (
            ...
            <div className="bg-muted/50 rounded-lg p-4 space-y-2">
              <p className="font-semibold text-sm">طرق الدفع كاش او تحويل بنكي او كود</p>
              <p className="font-semibold text-sm">خطوات الإيداع:</p>
              <ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground">
                <li>قم بتحويل المبلغ المطلوب إلى رقم محفظة بنك مصر الرقمية أعلاه (من أي محفظة)</li>
