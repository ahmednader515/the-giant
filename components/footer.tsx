        ...
        <div className={`text-center text-muted-foreground ${
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-4">
            <a
              ...
              className="inline-block bg-brand/10 border-2 border-brand/20 rounded-lg px-4 py-2 hover:bg-brand/20 transition-colors"
            >
              <p className="font-semibold text-brand">واتساب : 01227682189</p>
            </a>
          </div>
